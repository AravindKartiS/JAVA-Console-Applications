...
public class vehicle {
    ...
    static ArrayList<Integer> l8 = new ArrayList<>();// VEHICLEid
    static ArrayList<String> l11 = new ArrayList<>();// VEHICLEprice
    // --------------------------------------------------------//
    ...
    static ArrayList<String> l10 = new ArrayList<>();// borrowdate
    ...
    public static void welcome() {
        ...
        System.out.flush();
        System.out.println("\t\tWELCOME TO RIDERS RENTAL SHOP");
        System.out.println();
    ...
    public static void addbook() {
        ...
        int j1 = sc.nextInt();
        System.out.println();
        System.out.println("ENTER THE VEHICLE QUANTITY");
        String j2 = sc.next();
        System.out.println();
    ...
    public static void view() {
        ...
        if (l2.size() < 1) {
            ...
            System.out.println("VEHICLE NUMBER ||  VEHICLE TYPE   ||  VEHICLE QUANTITY  ||   VEHICLE PRICE ");
    ...
    public static void delete() {
        ...
        for (int i = 0; i < l8.size(); i++) {
            System.out.println("VECHCILE ID : " + l8.get(i) + "||" + " VECHICLE NUMBER IS : " + l2.get(i) + "||"
                    + " VECHICLE TYPE : " + l3.get(i));
        }
        int k = sc.nextInt();
        int y = l8.indexOf(k);
        l2.remove(y);
